...
import VUXUANDIEP.TimeTableAdapter;
...
public class TimeTableAdapter extends RecyclerView.Adapter<TimeTableAdapter.PersonViewHolder> {
    ...
    public TimeTableAdapter(Context context, ArrayList<TimeTableObject> list){
        this.context= context;
        this.list = list;
    }
    public void setFilteredList(ArrayList<TimeTableObject> filteredList){
    ...
    public void onBindViewHolder(@NonNull PersonViewHolder holder, int position) {
        final TimeTableObject timeTableObject = list.get(position);
    ...
    private void onClick(TimeTableObject timeTableObject){
