...
public class consultant_details_Adapter extends ArrayAdapter {
    private Activity context;
    private int layoutID;
    private ArrayList<HocPhanDto> list = null;

    public consultant_details_Adapter(@NonNull Context context, int resource, @NonNull List objects) {
